...
import 'package:vir_assistant/models/inspectionList.dart';
import 'package:vir_assistant/view/HomePage.dart';

import '../controllers/shipController.dart';

class TwoTempBody extends StatefulWidget {
  const TwoTempBody({Key? key}) : super(key: key);

  @override
  _TwoTempBodyState createState() => _TwoTempBodyState();
}

class _TwoTempBodyState extends State<TwoTempBody> {
            ...
            child: pw.Container(
              decoration: pw.BoxDecoration(
                  border: const pw.Border(
                      bottom:
                          pw.BorderSide(width: 5, style: pw.BorderStyle.solid),
                      top: pw.BorderSide(width: 5, style: pw.BorderStyle.solid),
                      right:
                          pw.BorderSide(width: 5, style: pw.BorderStyle.solid),
                      left: pw.BorderSide(
                          width: 5, style: pw.BorderStyle.solid))),
              child: pw.Center(
                  child: pw.Align(
                ...
                child: pw.Padding(
                  ...
                  child: pw.Column(
                    children: [
                      ...
                      pw.Text(
                        shipController.dateVir.toString(),
                        style: pw.TextStyle(fontSize: 36),
                      ),
                      pw.Text(
                        'VIR Report',
                          ...
                          child: pw.Align(
                            ...
                            child: pw.Padding(
                              ...
                              child: pw.Column(
                                children: [
                                  pw.Text(
                                    defectName.text.toString(),
                                    style: pw.TextStyle(fontSize: 36),
                                  ),
                                  pw.Text(
                                    defectDesc.text.toString(),
